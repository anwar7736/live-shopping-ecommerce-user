                ...
                <div class="container-fluid">
                    <ul class="searchbar-inner col-12">
                        ...
                        <li class="search-box ps-lg-3">
                            <input type="text" class="search-input" v-model="query" @keyup.enter="searchProduct" placeholder="Product search here...">
                ...
                <div class="m-row">
                    <div class="mobile-sidebar collapsed-left-open">
                        <form action="javascript: void(0)" class="mobile-sidebar-form">
                            <input type="text" class="msf-input" v-model="query" @keyup.enter="searchProduct"  placeholder="Product search here...">
